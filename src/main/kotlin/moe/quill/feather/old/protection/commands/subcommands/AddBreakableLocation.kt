...
class AddBreakableLocation(private val protectionModule: ProtectionModule, private val toolManager: SelectToolManager) :
    FeatherSubCommand {

    override fun getName(): String {
        return "add-break-loc";
    }

    override fun getDescription(): String {
        return "Add a breakable location to the protection manager";
    }
